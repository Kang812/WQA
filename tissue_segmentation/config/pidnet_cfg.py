...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=800, type='CheckpointHook', save_best='mIoU'),
...
test_pipeline = [
    ...
    dict(keep_ratio=False, scale=(1024, 1024), type='Resize'),
...
train_cfg = dict(
    max_iters=8000, type='IterBasedTrainLoop', val_interval=800)
